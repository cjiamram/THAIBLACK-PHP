...
function displayData(){
		var url="tclassifytransaction/displayData.php?tableName=t_classifytransaction&dbName=dbbeefjudge&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tclassifytransaction/create.php';
		jsonObj={
...
function updateData(){
		var url='tclassifytransaction/update.php';
		jsonObj={
			beefCode:$("#obj_beefCode").val(),
			beefNo:$("#obj_beefNo").val(),
			grade:$("#obj_grade").val(),
...
function readOne(id){
		var url='tclassifytransaction/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
			$("#obj_beefCode").val(data.beefCode);
			$("#obj_beefNo").val(data.beefNo);
			$("#obj_grade").val(data.grade);
...
function confirmDelete(id){
		...
		if (willDelete.value) {
			url="tclassifytransaction/delete.php?id="+id;
