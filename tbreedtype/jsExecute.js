...
function displayData(){
		var url="tbreedtype/displayData.php?tableName=t_breedtype&dbName=dbbeefclassify&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tbreedtype/create.php';
		jsonObj={
			code:$("#obj_code").val(),
...
function readOne(id){
		var url='tbreedtype/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
...
function confirmDelete(id){
		...
		if (willDelete.value) {
			url="tbreedtype/delete.php?id="+id;
