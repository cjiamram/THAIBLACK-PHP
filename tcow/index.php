...
<section class="content-header">
    ...
    <section class="content container-fluid">
      ...
      <h3 class="box-title"><b><?=$objLbl->getLabel("t_cow","CowInfo","th").":"?></b></h3>
      </div>
     ...
     <div class="modal-dialog" id="dvInput" style="width:800px" >
      <div class="modal-content">
          <div class="box-header with-border">
                ...
                <h4 class="modal-title"><?=$objLbl->getLabel("t_cow","CowInfo","th").":"?></h4>
           </div>
...
<script>
 ...
 function loadInput(){
      var url="<?=$rootPath.'/'.$lastPath?>/inputCowInit.php";
      $("#dvInputBody").load(url);
 }

function displayData(){
 
    var url="<?=$rootPath.'/'.$lastPath?>/displayCowInit.php??keyWord="+$("#txtSearch").val();
    $("#tblDisplay").load(url);
 }
